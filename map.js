 ...
 *
 * Угловые точки схемы карьера (фиксированные):
 *   X: 45850 — 47350  (локальные, без OFF_X)
 *   Y: 15800 — 17350
...
var MapModule = (function() {
  ...
  function sk42ToWgs84(xLocal, yLocal) {
    ...
    var zone  = 6;
    var y0    = yLocal; // уже без смещения зоны
    var x0    = xFull;
    var a  = 6378245.0, b = 6356863.019;
    var e2 = (a*a - b*b) / (a*a);
  ...
  return {
    ...
    pixelToLocal: pixelToLocal, toPixel: toPixel,
